...
from .representations import zscore_neurons, pca_reduce, build_representations, pca_reduce_tuning, tuning_to_matrix
...
from .analysis import (assign_age_groups, assign_per_monkey_age_groups,
                       ...
                       extract_entry_arrays, cross_monkey_by_group)
